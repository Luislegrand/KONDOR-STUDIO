...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/reports", label: "Relatorios", icon: CalendarDays },
    ],
  },
  {
    label: "Configuracoes",
    ...
    <SidebarProvider>
      <div className="min-h-screen bg-[var(--background)] text-[var(--text)] flex">
        <Sidebar className="hidden lg:flex">
          <SidebarHeader className="border-[var(--border)]">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                <img src={logoHeader} alt="Kondor Studio" className="h-9 w-auto" />
                <span className="text-xs font-semibold text-gray-500">Kondor</span>
              </div>
          ...
          <SidebarFooter className="border-[var(--border)]">
        ...
        <div className="flex-1 flex flex-col">
          <header className="sticky top-0 z-40 flex items-center justify-between border-b border-[var(--border)] bg-[var(--surface)] px-6 py-4">
            <div className="flex items-center gap-3">
              <button
                type="button"
